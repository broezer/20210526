...
function draw() {
  ...
  push();
  //image(pg02,0,0, width, height/2);
  //image(pg,0,height/2, width, height/2);
  pop();
  ...
  //rotate(HALF_PI);
  image(pg,  0 , 0, width * 1.4, height * 1.4);
  image(pg02,  0 , 0, width, height/1);
  image(pg,  0 , 0, width/1.6, height/1.6);
  pop();
  
  
  push()
  imageMode(CENTER);
  translate(width * 0.5, height * 1.15);
  rotate(HALF_PI);
  image(pg,  0 , 0, width * 1.4, height * 1.4);
  image(pg02,  0 , 0, width, height/1);
  image(pg,  0 , 0, width/1.6, height/1.6);
  ...
  push()
  imageMode(CENTER);
  translate(width * 1.25, height * 1.15);
  //rotate(HALF_PI);
  image(pg,  0 , 0, width * 1.4, height * 1.4);
  image(pg02,  0 , 0, width, height/1);
  image(pg,  0 , 0, width/1.6, height/1.6);
  ...
  grdTriangle(0, 0, width * 0.55, c2,c1);
